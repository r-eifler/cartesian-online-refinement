...
bool Heuristic::online_Refine(const GlobalState &global_state, std::vector<std::pair<GlobalState, int>> succStates, std::vector<GlobalState>){
...
bool Heuristic::online_Refine(const GlobalState& , const GlobalState&, int ){
	return false;
}
